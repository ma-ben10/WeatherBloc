...
class Watherrepository {
  ...
  Future<Weather> getWeatherFromLocation() async {
    if (await internetapi.checkConnectivity()) {
      ...
      try {
        ...
        throw Exception("Failed to get weather info using current location");
      }
    } else {
  ...
  Future<Weather> getWeatherFromCity(String city) async {
    if (await internetapi.checkConnectivity()) {
      try {
        ...
        throw Exception("Failed to get weather info using cityName");
      }
    } else {
      throw Exception("Connection Failed");
    }
